/* Set variable to use one button for navigation bar */
var navValue = false;

/* Call the navigation bar function from navValue variable */
...
function openNav() {
    ...
    document.getElementById("mainBody").style.marginLeft = "320px";
}
